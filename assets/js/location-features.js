...
if (typeof mulopimfwc_locationWiseProducts_map !== 'undefined' && mulopimfwc_locationWiseProducts_map.enableUserLocations === 'on') {
    ...
    jQuery(document).ready(function ($) {
        ...
        const LocationFeatures = {
            ...
            handleLocationFormSubmit: function (e) {
                ...
                $.ajax({
                    url: mulopimfwc_locationWiseProducts_map.ajaxUrl,
                    type: 'POST',
            ...
            setUserLocation: function (locationId) {
                const date = new Date();
                const days = mulopimfwc_script_map.cookie_expiry || 30; // Default to 30 days
                date.setTime(date.getTime() + days * 86400); 
                const expires = `expires=${date.toUTCString()}`;

                document.cookie = `mulopimfwc_user_location=${locationId}; ${expires}; path=/`;
            },
