...
if (!defined('mulopimfwc_VERSION')) {
    define("mulopimfwc_VERSION", "1.0.8.1");
}
...
if (!function_exists('mulopimfwc_get_values')) {
    ...
    class mulopimfwc_Location_Wise_Products
    {
        ...
        public function enqueue_scripts()
        {
            ...
            wp_enqueue_style('mulopimfwc_style', plugins_url('assets/css/style.css', __FILE__), [], '1.0.8.1');
            wp_enqueue_style('mulopimfwc_select2', plugins_url('assets/css/select2.min.css', __FILE__), [], '4.1.0');
            wp_enqueue_script('mulopimfwc_script', plugins_url('assets/js/script.js', __FILE__), ['jquery'], '1.0.8.1', true);
        ...
        {
            wp_enqueue_style('mulopimfwc-custom-admin-style', plugin_dir_url(__FILE__) . 'assets/css/admin-style.css', array(), "1.0.8.1");
        }
